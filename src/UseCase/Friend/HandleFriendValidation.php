...
class HandleFriendValidation extends HerissonUseCase
{
    ...
    public function execute(HandleFriendValidationRequest $request, HandleFriendValidationResponse $response)
    {
